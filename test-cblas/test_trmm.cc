...
void test_trmm_work( Params& params, bool run )
{
    ...
    assert_throw(( tmblas::trmm<TA,TB>( Side(0), uplo,    trans, diag,     m,  n, alphat, At, lda, Bt, ldb )), blas::Error );
    assert_throw(( tmblas::trmm<TA,TB>( side,    Uplo(0), trans, diag,     m,  n, alphat, At, lda, Bt, ldb )), blas::Error );
    assert_throw(( tmblas::trmm<TA,TB>( side,    uplo,    Op(0), diag,     m,  n, alphat, At, lda, Bt, ldb )), blas::Error );
    assert_throw(( tmblas::trmm<TA,TB>( side,    uplo,    trans, Diag(0),  m,  n, alphat, At, lda, Bt, ldb )), blas::Error );
    assert_throw(( tmblas::trmm<TA,TB>( side,    uplo,    trans, diag,    -1,  n, alphat, At, lda, Bt, ldb )), blas::Error );
    assert_throw(( tmblas::trmm<TA,TB>( side,    uplo,    trans, diag,     m, -1, alphat, At, lda, Bt, ldb )), blas::Error );

    assert_throw(( tmblas::trmm<TA,TB>( Side::Left,  uplo,   trans, diag,     m,  n, alphat, At, m-1, Bt, ldb )), blas::Error );
    assert_throw(( tmblas::trmm<TA,TB>( Side::Right, uplo,   trans, diag,     m,  n, alphat, At, n-1, Bt, ldb )), blas::Error );

    assert_throw(( tmblas::trmm<TA,TB>( side, uplo, trans, diag,    m,  n, alphat, At, lda, Bt, m-1 )), blas::Error );
	#endif
...
void test_trmm( Params& params, bool run )
{
    switch (params.datatype()) {
        case testsweeper::DataType::Single:
            test_trmm_work< float, float, float, float >( params, run );
            break;

        case testsweeper::DataType::Double:
            test_trmm_work< double, double, double, double >( params, run );
            break;

        case testsweeper::DataType::Quadruple:
            test_trmm_work< double, double, quadruple, quadruple >( params, run );
            break;

        case testsweeper::DataType::SingleComplex:
            test_trmm_work< std::complex<float>, std::complex<float>, std::complex<float>, std::complex<float> >
                ( params, run );
            break;

        case testsweeper::DataType::DoubleComplex:
            test_trmm_work< std::complex<double>, std::complex<double>, std::complex<double>, std::complex<double> >
                ( params, run );
            break;

        case testsweeper::DataType::QuadrupleComplex:
            test_trmm_work< std::complex<double>, std::complex<double>, std::complex<quadruple>, std::complex<quadruple> >
                ( params, run );
            break;
