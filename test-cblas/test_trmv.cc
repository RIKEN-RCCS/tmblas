...
void test_trmv_work( Params& params, bool run )
{
    ...
    assert_throw(( tmblas::trmv<TA,TX>( Uplo(0), trans, diag,     n, At, lda, xt, incx )), blas::Error );
    assert_throw(( tmblas::trmv<TA,TX>( uplo,    Op(0), diag,     n, At, lda, xt, incx )), blas::Error );
    assert_throw(( tmblas::trmv<TA,TX>( uplo,    trans, Diag(0),  n, At, lda, xt, incx )), blas::Error );
    assert_throw(( tmblas::trmv<TA,TX>( uplo,    trans, diag,    -1, At, lda, xt, incx )), blas::Error );
    assert_throw(( tmblas::trmv<TA,TX>( uplo,    trans, diag,     n, At, n-1, xt, incx )), blas::Error );
    assert_throw(( tmblas::trmv<TA,TX>( uplo,    trans, diag,     n, At, lda, xt,    0 )), blas::Error );
	#endif
...
void test_trmv( Params& params, bool run )
{
    switch (params.datatype()) {
        case testsweeper::DataType::Single:
            test_trmv_work< float, float, float, float >( params, run );
            break;

        case testsweeper::DataType::Double:
            test_trmv_work< double, double, double, double >( params, run );
            break;

        case testsweeper::DataType::Quadruple:
            test_trmv_work< double, double, quadruple, quadruple >( params, run );
            break;

        case testsweeper::DataType::SingleComplex:
            test_trmv_work< std::complex<float>, std::complex<float>, std::complex<float>, std::complex<float> >
                ( params, run );
            break;

        case testsweeper::DataType::DoubleComplex:
            test_trmv_work< std::complex<double>, std::complex<double>, std::complex<double>, std::complex<double> >
                ( params, run );
            break;

        case testsweeper::DataType::QuadrupleComplex:
            test_trmv_work< std::complex<double>, std::complex<double>, std::complex<quadruple>, std::complex<quadruple> >
                ( params, run );
            break;
