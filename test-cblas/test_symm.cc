...
void test_symm_work( Params& params, bool run )
{
    ...
    assert_throw(( tmblas::symm<TA,TB,TC>( Side(0),  uplo,     m,  n, alphat, At, lda, Bt, ldb, betat, Ct, ldc )), blas::Error );
    assert_throw(( tmblas::symm<TA,TB,TC>( side,     Uplo(0),  m,  n, alphat, At, lda, Bt, ldb, betat, Ct, ldc )), blas::Error );
    assert_throw(( tmblas::symm<TA,TB,TC>( side,     uplo,    -1,  n, alphat, At, lda, Bt, ldb, betat, Ct, ldc )), blas::Error );
    assert_throw(( tmblas::symm<TA,TB,TC>( side,     uplo,     m, -1, alphat, At, lda, Bt, ldb, betat, Ct, ldc )), blas::Error );

    assert_throw(( tmblas::symm<TA,TB,TC>( Side::Left,  uplo,     m,  n, alphat, At, m-1, Bt, ldb, betat, Ct, ldc )), blas::Error );
    assert_throw(( tmblas::symm<TA,TB,TC>( Side::Right, uplo,     m,  n, alphat, At, n-1, Bt, ldb, betat, Ct, ldc )), blas::Error );

    assert_throw(( tmblas::symm<TA,TB,TC>( side, uplo,  m,  n, alphat, At, lda, Bt, m-1, betat, Ct, ldc )), blas::Error );
    assert_throw(( tmblas::symm<TA,TB,TC>( side, uplo,  m,  n, alphat, At, lda, Bt, ldb, betat, Ct, m-1 )), blas::Error );
	#endif
    ...
    tmblas::symm<TA,TB,TC>( side, uplo, m, n,
...
void test_symm( Params& params, bool run )
{
    switch (params.datatype()) {
        case testsweeper::DataType::Single:
            test_symm_work< float, float, float, float, float, float >( params, run );
            break;

        case testsweeper::DataType::Double:
            test_symm_work< double, double, double, double, double, double >( params, run );
            break;

        case testsweeper::DataType::Quadruple:
            test_symm_work< double, double, double, quadruple, quadruple, quadruple >( params, run );
            break;

        case testsweeper::DataType::SingleComplex:
            test_symm_work< std::complex<float>, std::complex<float>, std::complex<float>,
            				std::complex<float>, std::complex<float>, std::complex<float> >( params, run );
            break;

        case testsweeper::DataType::DoubleComplex:
            test_symm_work< std::complex<double>, std::complex<double>, std::complex<double>,
