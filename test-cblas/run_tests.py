...
group_opt.add_argument( '--type',   action='store', help='default=%(default)s', default='s,d,q,c,z,y' )
...
if (opts.blas3):
    ...
    [ 'gemmt',  dtype        + layout + align + uplo + transA + transB + nk ],
