...
void test_gemm_work( Params& params, bool run )
{
    ...
    assert_throw(( tmblas::gemm<TA,TB,TC>( Op(0),  transB,  m,  n,  k, alphat, At, lda, Bt, ldb, betat, Ct, ldc )), blas::Error );
    assert_throw(( tmblas::gemm<TA,TB,TC>( transA, Op(0),   m,  n,  k, alphat, At, lda, Bt, ldb, betat, Ct, ldc )), blas::Error );
    assert_throw(( tmblas::gemm<TA,TB,TC>( transA, transB, -1,  n,  k, alphat, At, lda, Bt, ldb, betat, Ct, ldc )), blas::Error );
    assert_throw(( tmblas::gemm<TA,TB,TC>( transA, transB,  m, -1,  k, alphat, At, lda, Bt, ldb, betat, Ct, ldc )), blas::Error );
    assert_throw(( tmblas::gemm<TA,TB,TC>( transA, transB,  m,  n, -1, alphat, At, lda, Bt, ldb, betat, Ct, ldc )), blas::Error );

    assert_throw(( tmblas::gemm<TA,TB,TC>( Op::NoTrans,   Op::NoTrans, m, n, k, alphat, At, m-1, Bt, ldb, betat, Ct, ldc )), blas::Error );
    assert_throw(( tmblas::gemm<TA,TB,TC>( Op::Trans,     Op::NoTrans, m, n, k, alphat, At, k-1, Bt, ldb, betat, Ct, ldc )), blas::Error );
    assert_throw(( tmblas::gemm<TA,TB,TC>( Op::ConjTrans, Op::NoTrans, m, n, k, alphat, At, k-1, Bt, ldb, betat, Ct, ldc )), blas::Error );

    assert_throw(( tmblas::gemm<TA,TB,TC>( Op::NoTrans, Op::NoTrans,   m, n, k, alphat, At, lda, Bt, k-1, betat, Ct, ldc )), blas::Error );
    assert_throw(( tmblas::gemm<TA,TB,TC>( Op::NoTrans, Op::Trans,     m, n, k, alphat, At, lda, Bt, n-1, betat, Ct, ldc )), blas::Error );
    assert_throw(( tmblas::gemm<TA,TB,TC>( Op::NoTrans, Op::ConjTrans, m, n, k, alphat, At, lda, Bt, n-1, betat, Ct, ldc )), blas::Error );

    assert_throw(( tmblas::gemm<TA,TB,TC>( transA, transB, m, n, k, alphat, At, lda, Bt, ldb, betat, Ct, m-1 )), blas::Error );
	#endif
    ...
    tmblas::gemm<TA,TB,TC>( transA, transB, m, n, k,
...
void test_gemm( Params& params, bool run )
{
    switch (params.datatype()) {
        case testsweeper::DataType::Single:
            test_gemm_work< float, float, float, float, float, float >( params, run );
            break;

        case testsweeper::DataType::Double:
            test_gemm_work< double, double, double, double, double, double >( params, run );
            break;

        case testsweeper::DataType::Quadruple:
            test_gemm_work< double, double, double, quadruple, quadruple, quadruple >( params, run );
            break;

        case testsweeper::DataType::SingleComplex:
            test_gemm_work< std::complex<float>, std::complex<float>, std::complex<float>,
            				std::complex<float>, std::complex<float>, std::complex<float> >( params, run );
            break;

        case testsweeper::DataType::DoubleComplex:
            test_gemm_work< std::complex<double>, std::complex<double>, std::complex<double>,
