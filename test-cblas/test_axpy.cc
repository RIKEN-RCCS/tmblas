...
void test_axpy_work( Params& params, bool run )
{
    ...
    assert_throw(( tmblas::axpy<TX,TY>( -1, alphat, xt, incx, yt, incy )), blas::Error );
    assert_throw(( tmblas::axpy<TX,TY>(  n, alphat, xt,    0, yt, incy )), blas::Error );
    assert_throw(( tmblas::axpy<TX,TY>(  n, alphat, xt, incx, yt,    0 )), blas::Error );
	#endif
...
//            break;
        ...
        case testsweeper::DataType::Single:
            test_axpy_work< float, float, float, float >( params, run );
            break;

        case testsweeper::DataType::Double:
            test_axpy_work< double, double, double, double >( params, run );
            break;

        case testsweeper::DataType::Quadruple:
            test_axpy_work< double, double, quadruple, quadruple >( params, run );
            break;

//        case testsweeper::DataType::Octuple:
//            test_axpy_work< double, double, octuple, octuple >( params, run );
//            break;
...
//            break;
        ...
        case testsweeper::DataType::SingleComplex:
            test_axpy_work< std::complex<float>, std::complex<float>, std::complex<float>, std::complex<float> >
                ( params, run );
            break;

        case testsweeper::DataType::DoubleComplex:
            test_axpy_work< std::complex<double>, std::complex<double>, std::complex<double>, std::complex<double> >
                ( params, run );
            break;

        case testsweeper::DataType::QuadrupleComplex:
            test_axpy_work< std::complex<double>, std::complex<double>, std::complex<quadruple>, std::complex<quadruple> >
                ( params, run );
            break;

//        case testsweeper::DataType::OctupleComplex:
//            test_axpy_work< std::complex<double>, std::complex<double>, std::complex<octuple>, std::complex<octuple> >
//                ( params, run );
//            break;
