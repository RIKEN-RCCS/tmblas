...
{
	#if defined (INTEL_MKL_TEST)
    mkl_somatcopy( layout, trans, rows, cols, alpha, A, lda, B, ldb );
	#endif
}
...
{
	#if defined (INTEL_MKL_TEST)
    mkl_domatcopy( layout, trans, rows, cols, alpha, A, lda, B, ldb );
	#endif
}
...
{
	#if defined (INTEL_MKL_TEST)
    mkl_comatcopy( layout, trans, rows, cols, alpha, A, lda, B, ldb );
	#endif
}
...
{
	#if defined (INTEL_MKL_TEST)
    mkl_zomatcopy( layout, trans, rows, cols, alpha, A, lda, B, ldb );
	#endif
}
...
inline void
cblas_gemmt(
    CBLAS_LAYOUT layout, CBLAS_UPLO uplo, CBLAS_TRANSPOSE transA, CBLAS_TRANSPOSE transB,
    int n, int k,
    float  alpha,
    float const *A, int lda,
...
{
	#if defined (INTEL_MKL_TEST)
    cblas_sgemmt( layout, uplo, transA, transB, n, k,
                 alpha, A, lda, B, ldb,
                 beta,  C, ldc );
	#endif
}
...
{
	#if defined (INTEL_MKL_TEST)
    cblas_dgemmt( layout, uplo, transA, transB, n, k,
                 alpha, A, lda, B, ldb,
                 beta,  C, ldc );
	#endif
}
...
{
	#if defined (INTEL_MKL_TEST)
    cblas_cgemmt( layout, uplo, transA, transB, n, k,
                 &alpha, A, lda, B, ldb,
                 &beta,  C, ldc );
	#endif
}
...
{
	#if defined (INTEL_MKL_TEST)
    cblas_zgemmt( layout, uplo, transA, transB, n, k,
                 &alpha, A, lda, B, ldb,
                 &beta,  C, ldc );
	#endif
}
