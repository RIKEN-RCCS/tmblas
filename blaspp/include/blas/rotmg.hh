    ...
    T  param[5] )
{
    ...
    // Constants
    const T zero(0);          //  29 Jun.2023 AS    
    const T one(1);           //  29 Jun.2023 AS    
    const T gam(4096);        //  29 Jun.2023 AS     
    const T gamsq(gam*gam);   //  29 Jun.2023 AS    
    const T rgamsq(one/gamsq);//  29 Jun.2023 AS    
