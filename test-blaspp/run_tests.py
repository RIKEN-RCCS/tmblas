...
group_opt.add_argument( '--type',   action='store', help='default=%(default)s', default='s,d,q,o,c,z,y,x' )
group_opt.add_argument( '--layout', action='store', help='default=%(default)s', default='c' )
...
group_opt.add_argument( '--alphar', action='store', help='default=%(default)s', default='' )
group_opt.add_argument( '--alphai', action='store', help='default=%(default)s', default='' )
group_opt.add_argument( '--beta',  action='store', help='default=%(default)s', default='' )
group_opt.add_argument( '--betar',  action='store', help='default=%(default)s', default='' )
group_opt.add_argument( '--betai',  action='store', help='default=%(default)s', default='' )
...
#dtype_real    = ' --type ' + filter_csv( ('s', 'd', 'q', 'o'), opts.type )
dtype_real    = ' --type ' + filter_csv( ('d', 'q', 'o'), opts.type )
#dtype_complex = ' --type ' + filter_csv( ('c', 'z', 'y', 'x'), opts.type )
dtype_complex = ' --type ' + filter_csv( ('z', 'y', 'x'), opts.type )
dtype_all    = ' --type ' + filter_csv( ('d', 'q', 'o', 'z', 'y', 'x'), opts.type )
...
#    [ 'asum',  dtype      + n + incx_pos ],
    [ 'axpy',  dtype_all      + n + incx + incy ],
#    [ 'copy',  dtype      + n + incx + incy ],
    [ 'dot',   dtype_all   + n + incx + incy ],
#    [ 'dotu',  dtype      + n + incx + incy ],
    [ 'iamax', dtype_all   + n + incx_pos ],
    [ 'nrm2',  dtype_all  + n + incx_pos ],
#    [ 'rot',   dtype      + n + incx + incy ],
#    [ 'rotg',  dtype ],
#    [ 'rotm',  dtype_real + n + incx + incy ],
#    [ 'rotmg', dtype_real ],
    [ 'scal',  dtype_all   + n + incx_pos ],
...
if (opts.blas2):
    cmds += [
    [ 'gemv',  dtype_all     + layout + align + trans + mn + incx + incy ],
    [ 'hemv',  dtype_complex + layout + align + uplo + n + incx + incy ],
    [ 'ger',   dtype_all    + layout + align + mn + incx + incy ],
    [ 'geru',  dtype_complex + layout + align + mn + incx + incy ],

    [ 'her',   dtype_complex + layout + align + uplo + n + incx ],
    [ 'her2',  dtype_complex + layout + align + uplo + n + incx + incy ],
    [ 'symv',  dtype_all + layout + align + uplo + n + incx + incy ], # complex is in lapack++
    [ 'hemv',  dtype_complex + layout + align + uplo + n + incx + incy ], 
    [ 'syr',   dtype_all  + layout + align + uplo + n + incx ], # complex is in lapack++
    [ 'syr2',  dtype_all  + layout + align + uplo + n + incx + incy ],
    [ 'trmv',  dtype_all  + layout + align + uplo + trans + diag + n + incx ],
    [ 'trsv',  dtype_all  + layout + align + uplo + trans + diag + n + incx ],
    ]

# Level 3
if (opts.blas3):
    cmds += [
    [ 'gemm',  dtype_all      + layout + align + transA + transB + mnk ],
    [ 'gemmt',  dtype_all     + layout + align + uplo + transA + transB + nk ],
    [ 'hemm',  dtype_complex + layout + align + side + uplo + mn ],
    [ 'symm',  dtype_all     + layout + align + side + uplo + mn ],
    [ 'trmm',  dtype_all     + layout + align + side + uplo + trans + diag + mn ],
    [ 'trsm',  dtype_all     + layout + align + side + uplo + trans + diag + mn ],
