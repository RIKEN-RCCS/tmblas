...
#if 0
    // test error exits
    assert_throw( tmblas::gemm( Op(0),  transB,  m,  n,  k, alphat, At, lda, Bt, ldb, betat, Ct, ldc ), blas::Error );
    assert_throw( tmblas::gemm( transA, Op(0),   m,  n,  k, alphat, At, lda, Bt, ldb, betat, Ct, ldc ), blas::Error );
    assert_throw( tmblas::gemm( transA, transB, -1,  n,  k, alphat, At, lda, Bt, ldb, betat, Ct, ldc ), blas::Error );
    assert_throw( tmblas::gemm( transA, transB,  m, -1,  k, alphat, At, lda, Bt, ldb, betat, Ct, ldc ), blas::Error );
    assert_throw( tmblas::gemm( transA, transB,  m,  n, -1, alphat, At, lda, Bt, ldb, betat, Ct, ldc ), blas::Error );

    assert_throw( tmblas::gemm( Op::NoTrans,   Op::NoTrans, m, n, k, alphat, At, m-1, Bt, ldb, betat, Ct, ldc ), blas::Error );
    assert_throw( tmblas::gemm( Op::Trans,     Op::NoTrans, m, n, k, alphat, At, k-1, Bt, ldb, betat, Ct, ldc ), blas::Error );
    assert_throw( tmblas::gemm( Op::ConjTrans, Op::NoTrans, m, n, k, alphat, At, k-1, Bt, ldb, betat, Ct, ldc ), blas::Error );

    assert_throw( tmblas::gemm( Op::NoTrans, Op::NoTrans,   m, n, k, alphat, At, lda, Bt, k-1, betat, Ct, ldc ), blas::Error );
    assert_throw( tmblas::gemm( Op::NoTrans, Op::Trans,     m, n, k, alphat, At, lda, Bt, n-1, betat, Ct, ldc ), blas::Error );
    assert_throw( tmblas::gemm( Op::NoTrans, Op::ConjTrans, m, n, k, alphat, At, lda, Bt, n-1, betat, Ct, ldc ), blas::Error );

    assert_throw( tmblas::gemm( transA, transB, m, n, k, alphat, At, lda, Bt, ldb, betat, Ct, m-1 ), blas::Error );
...
void test_gemm( Params& params, bool run )
{
    switch (params.datatype()) {
	  ...
	  test_gemm_work<float,
			 float, float, float,
			 float, float, float >( params, run );
            break;

        case testsweeper::DataType::Double:
	  test_gemm_work<double,
	  ...
	  test_gemm_work<double,
        ...
        case testsweeper::DataType::SingleComplex:
            test_gemm_work<std::complex<float>,
        ...
        case testsweeper::DataType::DoubleComplex:
            test_gemm_work<std::complex<double>,
