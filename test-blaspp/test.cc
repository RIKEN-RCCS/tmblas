...
//    { "swap",   test_swap,   Section::blas1   },
    ...
    { "gemmt",  test_gemmt,  Section::blas3   },
    { "",       nullptr,     Section::newline },
...
Params::Params():
    ...
    alpha     ( "alpha",   9, 4, ParamType::Value, pi,  -inf,     inf, "scalar alpha" ),
//    alphar    ( "alphar",  9, 4, ParamType::Value, pi,  -inf,     inf, "scalar alpha" ),
    alphai    ( "alphai",  9, 4, ParamType::Value, log2, -inf,    inf, "scalar alpha(imag)" ),
    beta      ( "beta",    9, 4, ParamType::Value,  e,  -inf,     inf, "scalar beta" ),
//    betar     ( "betar",   9, 4, ParamType::Value,  e,  -inf,     inf, "scalar beta" ),
    betai     ( "betai",   9, 4, ParamType::Value, log2,  -inf,     inf, "scalar beta(imag)" ),
    ...
    error     ( "error-max",         8, 2, PT_Output, no_data, 0, 0, "numerical error" ),
    error2    ( "error-l2",        8, 2, PT_Output, no_data, 0, 0, "numerical error 2" ),
