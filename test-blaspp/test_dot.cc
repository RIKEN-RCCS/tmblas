...
#if 0
    // test error exits
    assert_throw( tmblas::dot( -1, xt, incx, yt, incy ), blas::Error );
    assert_throw( tmblas::dot(  n, xt,    0, yt, incy ), blas::Error );
    assert_throw( tmblas::dot(  n, xt, incx, yt,    0 ), blas::Error );
...
//	scalar_t result = tmblas::type_conv<scalar_t, scalar_tt>(resultt);
    ...
    if (params.ref() == 'y' || params.check() == 'y') {
        ...
        testsweeper::flush_cache( params.cache() );
        time = get_wtime();
        scalar_t resultr = blas::dot <RX, RY> ( n, xr, incx, yr, incy );
        time = get_wtime() - time;
...
//            break;
        ...
        case testsweeper::DataType::Single:
            test_dot_work< float, float, float, float, float >( params, run );
            break;

        case testsweeper::DataType::Double:
            test_dot_work< double, double, double, double, double >( params, run );
            break;

        case testsweeper::DataType::Quadruple:
            test_dot_work< double, quadruple, quadruple, quadruple, quadruple >( params, run );
            break;

        case testsweeper::DataType::Octuple:
            test_dot_work< double, octuple, octuple, octuple, octuple >( params, run );
            break;
...
//            break;
        ...
        case testsweeper::DataType::SingleComplex:
            test_dot_work< std::complex<float>, std::complex<float>, std::complex<float>, std::complex<float>, std::complex<float> >
                ( params, run );
            break;

        case testsweeper::DataType::DoubleComplex:
            test_dot_work< std::complex<double>, std::complex<double>, std::complex<double>, std::complex<double>, std::complex<double> >
                ( params, run );
            break;

        case testsweeper::DataType::QuadrupleComplex:
            test_dot_work< std::complex<double>, std::complex<quadruple>, std::complex<quadruple>, std::complex<quadruple>, std::complex<quadruple> >
                ( params, run );
            break;

        case testsweeper::DataType::OctupleComplex:
            test_dot_work< std::complex<double>, std::complex<octuple>, std::complex<octuple>, std::complex<octuple>, std::complex<octuple> >
                ( params, run );
            break;
