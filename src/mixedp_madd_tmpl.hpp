...
#ifndef _MIXEDP_MADD_TMPL_HPP
#define _MIXEDP_MADD_TMPL_HPP
...
template<typename Td, typename Ta, typename Tb,
		   ...
		   blas::complex_type<Tb> const &b)
  {
    ...
    // cr += ar * br - ai * bi;
    // ci += ar * bi + ai * br;    
    mixedp_madd<Tdreal, Tareal, Tbreal>(cr, ar, br);
    mixedp_msub<Tdreal, Tareal, Tbreal>(cr, ai, bi);
    mixedp_madd<Tdreal, Tareal, Tbreal>(ci, ar, bi);
		   ...
		   blas::real_type<Tb> const &b)
  {
     ...
     typedef blas::real_type<Tb> Tbreal;
     Tdreal cr(real<Tdreal>(c)), ci(imag<Tdreal>(c));
     mixedp_madd<Tdreal, Tareal, Tbreal>(cr, real<Tareal>(a), b);
     mixedp_madd<Tdreal, Tareal, Tbreal>(ci, imag<Tareal>(a), b);     
     c = std::complex<Tdreal>(cr, ci);
  }
  template<typename Td, typename Ta, typename Tb>
  void mixedp_madd(blas::complex_type<Td> &c,
		  ...
		  blas::complex_type<Tb> const &b)
  {
     ...
     typedef blas::real_type<Tb> Tbreal;
     Tdreal cr(real<Tdreal>(c)), ci(imag<Tdreal>(c));
     mixedp_madd<Tdreal, Tareal, Tbreal>(cr, a, real<Tbreal>(b));
     mixedp_madd<Tdreal, Tareal, Tbreal>(ci, a, imag<Tbreal>(b));     
     c = std::complex<Tdreal>(cr, ci);
  }
		  ...
		  blas::real_type<Tb> const &b)
  {
    ...
    mixedp_madd<Tdreal, Tareal, Tbreal>(cr, a, b);
