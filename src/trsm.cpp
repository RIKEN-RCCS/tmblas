...
#include "tmblas.hpp"
#include "trsm_tmpl.hpp"

namespace tmblas {

template
void trsm<half, half, float>(
    blas::Side side,
    blas::Uplo uplo,
    blas::Op trans,
    blas::Diag diag,
...
template
void trsm<std::complex<half>, std::complex<half>, std::complex<float> >(
    blas::Side side,
    blas::Uplo uplo,
    blas::Op trans,
    blas::Diag diag,
...
template
void trsm<std::complex<float>, std::complex<float>, std::complex<double> >(
    blas::Side side,
    blas::Uplo uplo,
    blas::Op trans,
    blas::Diag diag,
...
template
void trsm<double, double, quadruple>(
    blas::Side side,
    blas::Uplo uplo,
    blas::Op trans,
    blas::Diag diag,
...
template
void trsm<std::complex<double>, std::complex<double>, std::complex<quadruple> >(
    blas::Side side,
    blas::Uplo uplo,
    blas::Op trans,
    blas::Diag diag,
...
template
void trsm<std::complex<half>, std::complex<half> >(
    blas::Side side,
    blas::Uplo uplo,
    blas::Op trans,
    blas::Diag diag,
...
template
void trsm<std::complex<quadruple>, std::complex<quadruple> >(
    blas::Side side,
    blas::Uplo uplo,
    blas::Op trans,
    blas::Diag diag,
...
template
void trsm<std::complex<octuple>, std::complex<octuple> >(
    blas::Side side,
    blas::Uplo uplo,
    blas::Op trans,
    blas::Diag diag,
...
template
void trsm<std::complex<float>, std::complex<half> >(
    blas::Side side,
    blas::Uplo uplo,
    blas::Op trans,
    blas::Diag diag,
...
template
void trsm<std::complex<half>, std::complex<float> >(
    blas::Side side,
    blas::Uplo uplo,
    blas::Op trans,
    blas::Diag diag,
...
template
void trsm<std::complex<double>, std::complex<float> >(
    blas::Side side,
    blas::Uplo uplo,
    blas::Op trans,
    blas::Diag diag,
...
template
void trsm<std::complex<float>, std::complex<double> >(
    blas::Side side,
    blas::Uplo uplo,
    blas::Op trans,
    blas::Diag diag,
...
template
void trsm<std::complex<double>, std::complex<quadruple> >(
    blas::Side side,
    blas::Uplo uplo,
    blas::Op trans,
    blas::Diag diag,
...
template
void trsm<std::complex<quadruple>, std::complex<double> >(
    blas::Side side,
    blas::Uplo uplo,
    blas::Op trans,
    blas::Diag diag,
