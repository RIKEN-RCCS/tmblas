...
// =============================================================================
/// General matrix-matrix multiply but updates only the upper or lower triangular part of the result matrix
/// \[
...
/// If uplo = Uplo::Upper, then the upper triangular part of the array c is used. 
/// If uplo = Uplo::Lower, then the lower triangular part of the array c is used.
///
/// @param[in] transA
