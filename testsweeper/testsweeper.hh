...
{
    ch = tolower( ch );
    if (ch != 'i' && ch != 's' && ch != 'd' && ch != 'q' && ch != 'o' && ch != 'c' && ch != 'z' && ch != 'y' && ch != 'x') {
...
inline DataType str2datatype( const char* str )
{
    ...
    if      (str_ == "i"
          ...
          || str_ == "r128"
          || str_ == "quad"
          || str_ == "quadruple"     ) return DataType::Quadruple;
    else if (str_ == "o"
          || str_ == "r256"
          || str_ == "oct"
          || str_ == "octuple"       ) return DataType::Octuple;
    else if (str_ == "c"
          || str_ == "c32"
          || str_ == "complex<float>"
          || str_ == "complex-float"
          ...
          || str_ == "c128"
          || str_ == "complex<quadruple>"
          || str_ == "complex-quadruple") return DataType::QuadrupleComplex;
    else if (str_ == "x"
          || str_ == "c256"
          || str_ == "complex<octuple>"
          || str_ == "complex-octuple") return DataType::OctupleComplex;
    else {
...
inline const char* datatype2str( DataType en )
{
    switch (en) {
        ...
        case DataType::Quadruple:     return "q";
        case DataType::Octuple:       return "o";
        case DataType::SingleComplex: return "c";
        case DataType::DoubleComplex: return "z";
        case DataType::QuadrupleComplex: return "y";
        case DataType::OctupleComplex:   return "x";
    }
    return "";
}
